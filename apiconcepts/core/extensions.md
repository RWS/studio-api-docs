...
You can easily instantiate a list of all the extension implementations registered with a particular extension point using the [ObjectRegistry<TExtensionAttribute, TExtensionType>](../../api/core/Sdl.Core.PluginFramework.ObjectRegistry-2.yml) class. 

# [C#](#tab/tabid-1)
[!code-csharp[HostApplication](./code_samples/HostApplication.cs#L71-L76)]
***

[ObjectRegistry<TExtensionAttribute, TExtensionType>](../../api/core/Sdl.Core.PluginFramework.ObjectRegistry-2.yml) is a generic class accepting two template parameters:
...
Returning to our message transmitter example, we want to write some custom code that sends a message using a message transmitter. We will let the user select the transmitter they would like to use. 
...
# [C#](#tab/tabid-1)
[!code-csharp[HostApplication](code_samples/HostApplication.cs#L73-L76)]
***